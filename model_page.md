...
Captured 2026-08-18 from the official OpenAI API pricing documentation at
<https://developers.openai.com/api/docs/pricing>. This snapshot supports the recorded
paid-equivalent calculations; current official pricing remains authoritative.
